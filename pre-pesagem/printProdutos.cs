    ...
    class printProdutos
    {
        ...
        public static void Print_DataGridView(DataGridView dgv1)
        {
            ...
            try
            {
                ...
                PrintTitle = "PRODUTOS CADASTRADOS";
                    ...
                    System.Drawing.Printing.PrintEventArgs e)
        {
            try
            {
                ...
                foreach (DataGridViewColumn GridCol in dgv.Columns)
                {
                    ...
                    if (!printProdutos.SelectedColumns.Contains(GridCol.HeaderText)) continue;
                    ...
                    else
                    {
                        if (NewPage)
                        {
                            ...
                            e.Graphics.MeasureString(PrintTitle, new Font(dgv.Font,
                                    FontStyle.Bold), e.MarginBounds.Width).Height +50);//TITTLE HEIGHT -13
                            ...
                            e.Graphics.DrawString(s, new Font(dgv.Font, FontStyle.Bold),
                                    ...
                                    FontStyle.Bold), FontStyle.Bold), e.MarginBounds.Width).Height +50);//DATE HEIGHT

                            // Desenha as colunas
                            tmpTop = e.MarginBounds.Top + 50;//COLUMN HEIGHT
                            i = 0;
                            foreach (DataGridViewColumn GridCol in dgv.Columns)
                            {
                                if (!GridCol.Visible) continue;
                                if (!printProdutos.SelectedColumns.Contains(GridCol.HeaderText))
                                    continue;
